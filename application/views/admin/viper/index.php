<form id="pagerForm" method="post" action="/admin/viper/index">
...
<div class="pageHeader">
    <form onsubmit="return navTabSearch(this);" action="/admin/viper/index" method="post">
        <div class="searchBar">
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="add" href="/admin/viper/add" target="dialog" width="800" height="400"><span>添加</span></a></li>
